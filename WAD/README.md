...
This first editing path deliberately keeps `local_count` and
`section2_index_raw` read-only: resizing the packed pool requires relocating all
later slices and is not yet exposed by the UI.
